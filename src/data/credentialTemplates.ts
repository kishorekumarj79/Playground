...
export const credentialTemplates: CredentialTemplate[] = [
  // PUBLIC SECTOR - Identity & Civil Registration
  {
    ...
    fields: [
      ...
      { key: "nationality", label: "Nationality", type: "select", required: true, options: ["Uganda", "Ethiopia", "Morocco", "Nigeria", "South Africa", "Brazil", "Philippines", "India", "Sri Lanka", "Kenya"] },
  ...
  // PUBLIC SECTOR - Regulatory
  {
    ...
    fields: [
      ...
      { key: "nationality", label: "Country of Registration", type: "select", required: true, options: ["Uganda", "Ethiopia", "Morocco", "Nigeria", "South Africa", "Brazil", "Philippines", "India", "Sri Lanka", "Kenya"] },
      { key: "validUntil", label: "Valid Until", type: "date", required: true },
    ],
  },
  ...
  // SUPPLY CHAIN - Logistics
  {
    ...
    fields: [
      ...
      { key: "nationality", label: "Flag State", type: "select", required: true, options: ["Uganda", "Ethiopia", "Morocco", "Nigeria", "South Africa", "Brazil", "Philippines", "India", "Sri Lanka", "Kenya"] },
    ],
  },
  // SUPPLY CHAIN - Sustainability
  {
    ...
    fields: [
      ...
      { key: "nationality", label: "Country of Origin", type: "select", required: true, options: ["Uganda", "Ethiopia", "Morocco", "Nigeria", "South Africa", "Brazil", "Philippines", "India", "Sri Lanka", "Kenya"] },
  ...
  // REAL ESTATE - Property Rights
  {
    ...
    fields: [
      ...
      { key: "nationality", label: "Owner Nationality", type: "select", required: true, options: ["Uganda", "Ethiopia", "Morocco", "Nigeria", "South Africa", "Brazil", "Philippines", "India", "Sri Lanka", "Kenya"] },
      { key: "registrationDate", label: "Registration Date", type: "date", required: true },
    ],
  },
];
...
export function templateToSchema(template: CredentialTemplate, country: string): CredentialSchema {
  const countryName = country === "global" ? "Global" :
  ...
  return {
    id: template.id,
    name: `${countryName} - ${template.name}`,
